...
All of it under [`spec/requirements.md`](spec/requirements.md) — 394 requirements
...
| [`.claude/skills/`](.claude/skills/) | Orchestration, contract guard, validation, version guard, visual QA, supply-chain audit, release |
| [`spec/`](spec/) | 394 requirements, the fleet roster, and a spec per domain |
