...
description: Implement local password+TOTP, passkeys/WebAuthn, Entra OIDC, sessions, step-up authentication and recovery with strong anti-phishing controls. Use for login/approval auth.
---
