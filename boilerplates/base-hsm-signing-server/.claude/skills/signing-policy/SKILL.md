---
name: signing-policy
description: Implement explainable signing-policy evaluation bound to trusted CI identity, artifact digest, ref, signing profile, approvals and expiry. Use for authorization decisions.
---
