...
description: Build secure Next.js App Router admin interfaces with Server Components by default, typed actions/APIs, shadcn UI, CSP and authorization. Use for SignZone web work.
---
