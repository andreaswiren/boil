---
name: os-control-rpc
description: Implement the typed root OS control daemon over Unix sockets without generic command execution. Use for network, firewall, services, updates, logs and support-bundle operations.
---
