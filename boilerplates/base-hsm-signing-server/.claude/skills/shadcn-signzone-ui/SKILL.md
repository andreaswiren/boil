...
description: Apply the SignZone red-accent Radix/shadcn visual system, dashboard patterns, accessibility, responsive behavior, dark mode and status semantics. Use for UI work.
---
