...
description: Implement canonical append-only audit events, hash chaining, checkpoints, export, remote syslog and redaction. Use whenever auditable actions are added.
---
