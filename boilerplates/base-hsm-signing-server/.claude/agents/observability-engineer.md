...
description: Owns health, metrics, structured logs, alerting, diagnostics, and redaction.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns health, metrics, structured logs, alerting, diagnostics, and redaction.
