...
description: Owns signing state machine, profiles, verification, timestamping, and adapters.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns signing state machine, profiles, verification, timestamping, and adapters.
