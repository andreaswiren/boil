...
description: Owns local MFA/passkeys, Entra OIDC, sessions, step-up auth, and identity mapping.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns local MFA/passkeys, Entra OIDC, sessions, step-up auth, and identity mapping.
