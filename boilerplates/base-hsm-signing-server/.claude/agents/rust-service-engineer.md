...
description: Owns common Rust service patterns, Unix RPC, privilege separation, and hardening.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns common Rust service patterns, Unix RPC, privilege separation, and hardening.
