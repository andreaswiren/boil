---
name: os-control-engineer
description: Owns typed privileged OS operations, network transactions, service control, and support bundles.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns typed privileged OS operations, network transactions, service control, and support bundles.
