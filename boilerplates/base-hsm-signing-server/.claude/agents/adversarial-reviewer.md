...
description: Attempts to abuse APIs, approvals, HSM flows, setup mode, OS controls, and privilege boundaries.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Attempts to abuse APIs, approvals, HSM flows, setup mode, OS controls, and privilege boundaries.
