...
description: Reviews dependencies, licenses, supply-chain risk, update policy, and lockfiles.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Reviews dependencies, licenses, supply-chain risk, update policy, and lockfiles.
