...
description: Owns idempotent Debian installer, bootstrap TLS, setup mode, service install, upgrades, and rollback.
tools: Read, Write, Edit, Bash, Grep, Glob
---

## Mission
Owns idempotent Debian installer, bootstrap TLS, setup mode, service install, upgrades, and rollback.
